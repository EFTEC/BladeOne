...
class BladeOne
{
    ...
    public function stopSection($overwrite = false)
    {
        ...
        echo "🅰️ stopping section [$last]<br>";
        if ($overwrite) {
    ...
    {
        echo "🅰️ extend section [$section]<br>";
    ...
    {
        echo "🅰️ starting section [$section]<br>";
        if ($content === '') {
            echo "🅰️ added to stack [$section]<br>";
    ...
    {
        echo "🅰️ checking if section[$section] exists<br>";
        if (isset($this->sections[$section])) {
            echo "🅰️ it exists<br>";
            $content = \str_replace($this->PARENTKEY, $default, $this->sections[$section]);
            return $content;
        } else {
            echo "🅰️ it doesn't<br>";
            return $default;
        }
    }
